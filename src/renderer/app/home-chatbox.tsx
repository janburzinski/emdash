...
export const HomeChatbox = observer(function HomeChatbox() {
  ...
  return (
    <div className="mx-auto w-full max-w-[640px]">
      <div className="overflow-hidden rounded-2xl border border-border bg-background shadow-[0_1px_2px_0_rgba(0,0,0,0.04),0_8px_24px_-8px_rgba(0,0,0,0.10)] transition-shadow hover:shadow-[0_1px_2px_0_rgba(0,0,0,0.04),0_12px_32px_-8px_rgba(0,0,0,0.14)]">
        <Textarea
          value={prompt}
        ...
        <div className="flex items-center gap-1 border-t border-border bg-background-1 px-4 py-1">
          <DropdownMenu>
            <DropdownMenuTrigger
              disabled={isUnborn}
